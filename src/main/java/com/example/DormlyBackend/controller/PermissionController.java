...
public class PermissionController {
    ...
    public ResponseEntity<ApiResponse<PermissionResponseDto>> create(@RequestBody @Valid PermissionRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.<PermissionResponseDto>builder().result(result).build());
    }
    ...
    public ResponseEntity<ApiResponse<List<PermissionResponseDto>>> list() {
        ...
        return ResponseEntity.ok(ApiResponse.<List<PermissionResponseDto>>builder().result(result).build());
    }
}
